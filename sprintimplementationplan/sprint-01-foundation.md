...
| 2026-08-14 | AWS identity audit | `aws sts get-caller-identity` | Verified principal: `arn:aws:iam::250368537925:user/deploy-admin`; it has no access to the configured production state bucket in account `059763918790`, so no plan/apply was attempted |
